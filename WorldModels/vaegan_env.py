...
from vaegan_rnn import MDNRNN, rnn_next_state, rnn_init_state
class CarRacingMDNRNN(CarRacingWrapper):
  def __init__(self, args, load_model=True, full_episode=False, with_obs=False):
    ...
    if load_model:
      self.E.load_weights('results/WorldModels/CarRacing-v0/tf_vaegan/encoder.h5')
