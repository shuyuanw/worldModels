...
DATA_DIR = "results/{}/{}/vaegan_series".format(args.exp_name, args.env_name)
model_save_path = "results/{}/{}/vaegan_rnn".format(args.exp_name, args.env_name)
...
#print(np.shape(np.random.permutation(N_data)))
